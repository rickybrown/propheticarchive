        ...
        },
        {
            ...
            options: {
                ...
                pages: [
                    ...
                    { path: '/{__metadata.urlPath}', predicate: _.matchesProperty('__metadata.modelName', 'prophecy') },
                    { path: '/{__metadata.urlPath}', predicate: _.matchesProperty('__metadata.modelName', 'showcase') },
